...
exports.run = (bot, message, args, func) => {
    ...
    db.set(`messageChannel_${message.guild.id}`, newChannel).then(i => {
        func.embed(message.channel, `**Canal de log atualizado com sucesso para ${message.mentions.channels.first()}**`) // Finally, send in chat that they updated the channel.
    })
