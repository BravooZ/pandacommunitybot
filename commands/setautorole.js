...
exports.run = (bot, message, args, func) => {
    ...
    if (!message.member.hasPermission('👑Fundador👑')) return message.channel.send('Isso requer que você tenha a role com `👑Fundador👑`') // Tell them that they dont have the proper perms
